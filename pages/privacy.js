...
export default function Privacy() {
  return (
    ...
    >
      ...
      <p>
        When you use our tool, we collect your WhatsApp messages temporarily in
        order to perform the analysis. However, we do not store any of your
      ...
      <p>
        We use secure encryption methods to protect your data while it is being
        transmitted to our servers, and we do not share your data with any third
        parties. We also provide clear instructions on how to revoke access to
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to OurChatStory.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to OurChatStory, accessible from{" "}
            <a
              href="https://ourchatstory.co/"
